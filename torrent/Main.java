...
public class Main {
    ...
    public static void main(String [] args){
        ...
        //Creo los leechers
        Leecher leecher_0 = new Leecher(0,semaforos,archivo_peer_0,tracker,server);
        Leecher leecher_1 = new Leecher(1,semaforos,archivo_peer_1,tracker,server);
        Leecher leecher_2 = new Leecher(2,semaforos,archivo_peer_2,tracker,server);
        Leecher leecher_3 = new Leecher(3,semaforos,archivo_peer_3,tracker,server);
